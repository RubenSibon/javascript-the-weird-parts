...
exports.translateApp = translateApp;
...
function formError() {
  ...
  if (error) {
    ...
    var errorText = document.createTextNode(_translations.translatableStrings[_config.CONFIG.state.currentLanguage]['formError']); // Append error notice to the form.
...
},{"./_config.js":"js/_config.js","./_translations.js":"js/_translations.js"}],"js/_userAccount.js":[function(require,module,exports) {
"use strict";
...
function logIn(approved) {
  ...
  console.log(j);
  j.addClass(_config.CONFIG.selectors.card, toAdd);
  j.removeClass(_config.CONFIG.selectors.card, toRemove);
}
},{"./_config.js":"js/_config.js"}],"js/app.js":[function(require,module,exports) {
"use strict";
  ...
  (function (G$, j$) {
    ...
    document.querySelector('#langSelect').addEventListener('change', function (event) {
      ...
      if (event.target.value !== _config.CONFIG.state.currentLanguage) {
        ...
        (0, _translateStrings.translateApp)(event.target.value);
      }
